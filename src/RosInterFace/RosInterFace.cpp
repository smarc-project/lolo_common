...
void RosInterFace::init(ros::NodeHandle* nh, CaptainInterFace* cap) { 
  ...
  speed_sub     = n->subscribe<smarc_msgs::Float32Stamped>("/lolo/core/speed_cmd"       ,1, &RosInterFace::ros_callback_speed,this);
  depth_sub     = n->subscribe<smarc_msgs::Float32Stamped>("/lolo/core/depth_cmd"       ,1, &RosInterFace::ros_callback_depth,this);
  altitude_sub  = n->subscribe<smarc_msgs::Float32Stamped>("/lolo/core/altitude_cmd"    ,1, &RosInterFace::ros_callback_altitude,this);

  //Control commands medium level
  yaw_sub       = n->subscribe<smarc_msgs::Float32Stamped>("/lolo/core/yaw_cmd"          ,1, &RosInterFace::ros_callback_yaw,this);
  yawrate_sub   = n->subscribe<smarc_msgs::Float32Stamped>("/lolo/core/yawrate_cmd"      ,1, &RosInterFace::ros_callback_yawrate,this);
  pitch_sub     = n->subscribe<smarc_msgs::Float32Stamped>("/lolo/core/pitch_cmd"        ,1, &RosInterFace::ros_callback_pitch,this);
  rpm_sub       = n->subscribe<smarc_msgs::Float32Stamped>("/lolo/core/rpm_cmd"          ,1, &RosInterFace::ros_callback_rpm, this);

  //Control commands low level
  //Thruster
  thrusterPort_sub = n->subscribe<smarc_msgs::Float32Stamped>("/lolo/core/thruster_port_cmd", 1, &RosInterFace::ros_callback_thrusterPort, this);
  ...
  //==================================//
  // --- Thrusters --- //
  thrusterPort_rpm_pub     = n->advertise<smarc_msgs::Float32Stamped>("/lolo/core/thruster_port_fb/rpm", 10);
  thrusterPort_current_pub = n->advertise<smarc_msgs::Float32Stamped>("/lolo/core/thruster_port_fb/current", 10);
  thrusterPort_torque_pub  = n->advertise<smarc_msgs::Float32Stamped>("/lolo/core/thruster_port_fb/torque", 10);

  thrusterStrb_rpm_pub     = n->advertise<smarc_msgs::Float32Stamped>("/lolo/core/thruster_strb_fb/rpm", 10);
  thrusterStrb_current_pub = n->advertise<smarc_msgs::Float32Stamped>("/lolo/core/thruster_strb_fb/current", 10);
  ...
  elevator_current_pub    = n->advertise<smarc_msgs::Float32Stamped>("/lolo/core/elevator_fb/current", 10);

  // --- Elevons --- //
  elevon_port_angle_pub   = n->advertise<smarc_msgs::Float32Stamped>("/lolo/core/elevon_port_fb/angle", 10);
  elevon_port_current_pub = n->advertise<smarc_msgs::Float32Stamped>("/lolo/core/elevon_port_fb/current", 10);

  elevon_strb_angle_pub   = n->advertise<smarc_msgs::Float32Stamped>("/lolo/core/elevon_strb_fb/angle", 10);
  elevon_strb_current_pub = n->advertise<smarc_msgs::Float32Stamped>("/lolo/core/elevon_strb_fb/current", 10);
